  ...
  <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-12">
        ...
        {{-- <a href="/admin/pegawai/createuser" class="btn btn-sm bg-purple"><i class="fas fa-key"></i> Create User &
          Pass ASN</a> --}}
                ...
                <tr>
                  ...
                  {{-- <td>
                    ...
                    <img
                      ...
                      alt="User" width="30px" class="brand-image img-circle elevation-3" style="opacity: .8">
                    @else
                    <img src="/storage/pegawai/{{$item->foto}}" alt="User" width="30px"
                  ...
                  <td>
                    ...
                    @else
                    <a href="/admin/pegawai/resetpass/{{$item->id}}" class="btn btn-xs btn-secondary"><i
                        class="fas fa-key"></i> Reset Pass</a>
                    @endif
                    {{-- <a href="/admin/pegawai/detail/{{$item->id}}" class="btn btn-xs btn-info" data-toggle="tooltip"
                      title='lihat data'><i class="fas fa-eye"></i></a> --}}
                    <a href="/admin/pegawai/edit/{{$item->id}}" class="btn btn-xs btn-warning" data-toggle="tooltip"
                      title='Edit data'><i class="fas fa-edit"></i></a>
                    {{-- <a href="/admin/pegawai/delete/{{$item->id}}" class="btn btn-xs btn-danger"
