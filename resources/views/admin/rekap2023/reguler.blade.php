        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/mp" class="btn btn-flat btn-xs btn-primary"
                    ...
                    Semua Pegawai</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/psa"
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/perhitungan"
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/kuncitpp" class="btn btn-flat btn-xs btn-danger"
