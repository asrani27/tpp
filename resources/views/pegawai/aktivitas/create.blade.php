        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              @if (Auth::user()->username == '197508312010011005' || Auth::user()->username == '198707242010011009' || Auth::user()->username == '198207022000121002' || Auth::user()->username == '196906081997032006')
