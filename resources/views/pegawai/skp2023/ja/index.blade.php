                        ...
                        <table class="table table-sm table-bordered">
                            <thead>
                                <tr
                                    ...
                                    <th>NO</th>
                                    <th colspan="2">PEGAWAI YG DINILAI <a
                                            href="/pegawai/new-skp/updatepegawai/{{$u->id}}"
                                            onclick="return confirm('Yakin ingin diupdate');"><i
                                                class="fa fa-refresh"></i> update</a></th>
                                    <th>NO</th>
                                    <th colspan="2">PEJABAT PENILAI KINERJA <a href="#" class="penilai"><i
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td>5</td>
                                    <td>UNIT KERJA</td>
                                    <td>{{$pn->unit_kerja}} <a href="#" class="unit-kerja"
                                            data-unitkerja="{{$pn->unit_kerja}}"><i class="fas fa-edit"></i></a></td>
                                    <td>5</td>
                                    <td>INSTANSI</td>
                            ...
                            <tbody>
                                ...
                                <tr
                                    ...
                                    <td rowspan="{{$item->indikator->count() + 1}}">{{$item->rhk_intervensi}}
                                        <a href="#" data-id="{{$item->id}}" data-rhk="{{$item->rhk}}"
                                            data-rhk_intervensi="{{$item->rhk_intervensi}}" class="edit-skp-utama"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="/pegawai/new-skp/jf/utama/rhk/{{$item->id}}/delete"
                                    ...
                                    @endif
                                    <td>{{$item2->aspek}}
                                        <a href="#" data-id="{{$item2->id}}" data-indikator="{{$item2->indikator}}"
                                            data-target="{{$item2->target}}" data-aspek="{{$item2->aspek}}"
                                            class="edit-indikator-utama"><i class="fas fa-edit"></i></a>
                                        <a href="/pegawai/new-skp/jf/utama/rhk/{{$item->id}}/indikator/{{$item2->id}}/delete"
                                            onclick="return confirm('Yakin ingin dihapus');"><i
                                                class="fas fa-trash"></i></a>
                                    </td>
                                ...
                                <tr
                                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                    <td><a href="#" class="indikator-skp-utama" data-id="{{$item->id}}"><i
                                ...
                                <tr>
                                    <td></td>
                                    <td><a href="#" class="btn btn-xs btn-primary skp-utama"><i
                                                class="fas fa-plus-circle"> tambah skp</a></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    ...
                                    <td colspan="6">
                                        <table>
                                            ...
                                            <tr
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><a href="#" class="btn btn-xs btn-primary isirencana"><i
                                                            class="fas fa-plus-circle"></td>
                                            </tr>
                                            @endforeach
                                        </table>
                                    </td>
                                ...
                                <tr
                                    ...
                                    <td rowspan="{{$item->indikator->count() + 1}}">{{$item->rhk_intervensi}}
                                        <a href="#" data-id="{{$item->id}}" data-rhk="{{$item->rhk}}"
                                            data-rhk_intervensi="{{$item->rhk_intervensi}}" class="edit-skp-tambahan"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="/pegawai/new-skp/jf/tambahan/rhk/{{$item->id}}/delete"
                                            onclick="return confirm('Yakin ingin dihapus');"><i
                                                class="fas fa-trash"></i></a>
                                    </td>
                                    <td rowspan="{{$item->indikator->count() + 1}}">{{$item->rhk}} </td>
                                    ...
                                    <td class="text-center">{{$item2->aspek}}
                                        <a href="#" data-id="{{$item2->id}}" data-indikator="{{$item2->indikator}}"
                                            data-target="{{$item2->target}}" data-aspek="{{$item2->aspek}}"
                                            class="edit-indikator-tambahan"><i class="fas fa-edit"></i></a>
                                        <a href="/pegawai/new-skp/jf/tambahan/rhk/{{$item->id}}/indikator/{{$item2->id}}/delete"
                                            onclick="return confirm('Yakin ingin dihapus');"><i
                                                class="fas fa-trash"></i></a>
                                    </td>
                                ...
                                <tr
                                    style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                    <td><a href="#" class="t-indikator-skp-tambahan" data-id="{{$item->id}}"><i
                                                class="fas fa-plus-circle"></i></a></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td></td>
                                    <td><a href="#" class="btn btn-xs btn-primary skp-tambahan"><i
                                                class="fas fa-plus-circle"> tambah skp</a></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
            ...
            <form method="post" action="/pegawai/new-skp/jf/utama/rhk/{{$u->id}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="rhk_intervensi" placeholder="rencana hasil kerja"
                            required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modal-tambah-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/jf/utama/rhk/{{$u->id}}/indikator"
...
<div class="modal fade" id="modal-edit-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/jf/utama/rhk/{{$u->id}}/indikator/edit"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                    <h4 class="modal-title text-sm">INDIKATOR SKP UTAMA</h4>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jf_indikator_id"
                            id="skp2023_jf_indikator_id">
                        <label>INDIKATOR</label>
        ...
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/jf/tambahan/rhk/{{$u->id}}/edit" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>RENCANA HASIL KERJA ATASAN YG DIINTERVENSI</label>
                        <input type="text" class="form-control" name="rhk_intervensi" id="rhk_intervensi_tambahan"
                            required>
                    </div>
                    <div class="form-group">
                        <label>RENCANA HASIL KERJA</label>
...
<div class="modal fade" id="t-modal-tambah-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/jf/tambahan/rhk/{{$u->id}}/indikator"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jf_id_tambahan"
                            id="skp2023_jf_id_tambahan" required>
                        <label>INDIKATOR</label>
                        <input type="text" class="form-control" name="indikator" placeholder="indikator" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="t-modal-edit-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/jf/tambahan/rhk/{{$u->id}}/indikator/edit"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jf_indikator_id_tambahan"
                            id="skp2023_jf_indikator_id_tambahan">
                        <label>INDIKATOR</label>
            ...
            <form method="post" action="/pegawai/new-skp/unitkerja/{{$u->id}}" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="unit kerja" id="unit_kerja"
