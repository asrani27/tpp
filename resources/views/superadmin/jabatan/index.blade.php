                                                ...
                                                @foreach ($item4->bawahan as $item5)
                                                    <li>
                                                        <div class="callout callout-danger text-sm" style="padding:5px;">
                                                            ...
                                                            <a href="/superadmin/skpd/jabatan/{{$skpd_id}}/edit/{{$item5->id}}" class="btn btn-tool" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i></a>
                                                            <a href="/superadmin/skpd/jabatan/{{$skpd_id}}/delete/{{$item5->id}}" class="btn btn-tool"  data-toggle="tooltip" title="Hapus" onclick="return confirm('Yakin ingin di hapus?');"><i class="fas fa-times"></i></a>
                                                        </div>
                                                    </li>
                                                @endforeach
                                            </ul>
