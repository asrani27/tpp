        ...
        <div class="row">
            <div class="col-lg-12 col-12">             
                <div class="card card-info">
                    ...
                    <h3 class="card-title"><i class="fas fa-university"></i> Edit SKPD</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form class="form-horizontal" method="POST" action="/superadmin/skpd/edit/{{$data->id}}">
                        @csrf
                    <div class="card-body">
                        <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Kode SKPD</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kode_skpd" value="{{$data->kode_skpd}}" required>
                        </div>
                        </div>
                        <div class="form-group row">
