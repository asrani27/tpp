    ...
    <div class="col-md-12">
        ...
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title"><i class="fas fa-paperclip"></i> Edit Lampiran WFH</h3>
            </div>
            <!-- form start -->
            <form id="lampiran" class="form-horizontal" method="POST"
                action="/pegawai/lampiran/wfh/edit/{{$data->id}}">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="url" class="form-control" name="url_google_drive"
                                ...
                                value="{{ old('url_google_drive', $data->url_google_drive) }}" required>
