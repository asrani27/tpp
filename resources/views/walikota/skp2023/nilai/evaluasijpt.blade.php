...
<div class="row">
    <div class="col-md-12">
        <a href="/home/walikota" class="btn btn-sm btn-secondary" type="submit"><i class="fas fa-arrow-left"></i>  Kembali</a><br/><br/>
        <div class="row">
            <div class="col-12">
              <div class="card">
              ...
              <div class="card">
                <div class="card-body p-1">
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <th>
                                <form method="post" action="/walikota/nilai-rhk/triwulan/{{$triwulan}}/{{$u->id}}">
                                    @csrf
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <td>Ekspektasi Khusus Pimpinan : <br/>
                                ...
                                <a href="/walikota/nilai-skp/ekspektasi/delete/{{$item->id}}" onclick="return confirm('Yakin Ingin Di hapus?');"><i class="fas fa-trash"></i></a> -{{$item->ekspektasi}} <br/>
                                @endforeach
                    ...
                    <table class="table table-sm table-bordered">
                        ...
                        <tr>
                            <th>
                                <form method="post" action="/walikota/nilai-rpk/triwulan/{{$triwulan}}/{{$u->id}}">
                                    @csrf
...
<div class="modal fade" id="modal-edit" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/walikota/nilai-skp/triwulan/{{$triwulan}}/{{$u->id}}/jpt" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modal-tambah" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/walikota/nilai-skp/ekspektasi/{{$u->id}}/triwulan" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
