...
<div class="modal fade" id="modal-tambahpegawai" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tambahpegawai/plt" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-success" style="padding:10px">
                ...
                <div class="modal-body">
                    ...
                    <select id="selectJabatanDefinitif" class="form-control form-control-sm select2 selectJabatanDefinitif" name="jabatan_definitif">
                          
                    </select>
                    <br />
                    Pilih Jabatan di PLT
                    <select id="selectJabatanPLT" class="form-control form-control-sm select2 selectJabatanPLT" name="jabatan_plt">
