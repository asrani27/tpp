...
<div class="row">
    <div class="col-md-12">
        ...
        <a href="/admin/sekolah" class="btn btn-sm btn-secondary"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a><br /><br />
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body table-responsive p-0">
                        <form class="form-horizontal" method="POST" action="/admin/sekolah/{{$data->id}}/edit">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Kepala Sekolah</label>
                                <div class="col-sm-10">
