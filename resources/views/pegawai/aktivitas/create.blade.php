        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              @if (Auth::user()->username == '197508312010011005' || Auth::user()->username == '198707242010011009'  || Auth::user()->username == '197002061992032005'  || Auth::user()->username == '199606272019031003' )
