            ...
            <table class="table table-hover text-nowrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="/admin/sekolah/{{$item->id}}/petajabatan" class="btn btn-sm bg-purple"
                      data-toggle="tooltip" title='Peta Jabatan'><i class="fas fa-sitemap"></i> PETA JABATAN</a>
                    <a href="/admin/sekolah/{{$item->id}}/edit" class="btn btn-sm btn-success" data-toggle="tooltip"
                      title='Edit'><i class="fas fa-edit"></i></a>
                    <a href="/admin/sekolah/{{$item->id}}/delete" class="btn btn-sm btn-danger" data-toggle="tooltip"
