...
<div class="row">
    <div class="col-md-12">
        <a href="/pegawai/nilai-skp" class="btn btn-sm btn-secondary" type="submit"><i class="fas fa-arrow-left"></i>
            Kembali</a><br /><br />
        <div class="row">
            <div class="col-12">
                <div class="card">
                                ...
                                <tr
                                    ...
                                    <td>Pimpinan : {{$item2['ub_tw'. $triwulan]}}
                                        <a href="#" data-id="{{$item2->id}}"
                                            data-umpan_balik="{{$item2['ub_tw'. $triwulan]}}"
                                            class="edit-umpan-balik"><i class="fas fa-edit"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                @endforeach
                                                ...
                                                <td>
                                                    <table>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="#" class="btn btn-xs btn-primary komentar"
                                                                    data-id="{{$rencana->id}}"
                                                                    data-komentar="{{$rencana->umpan_balik}}"><i
                        ...
                        <table class="table table-sm table-bordered">
                            <thead>
                                ...
                                <tr>
                                    <th>
                                        <form method="post"
                                            action="/pegawai/nilai-rhk/triwulan/{{$triwulan}}/{{$u->id}}">
                                            @csrf

                                            <select name="rating" class="form-control text-sm" required>
                                                <option value="">-pilih-</option>
                                                <option value="DIATAS EKSPEKTASI"
                                                    {{$u['rhk_tw'.$triwulan]=='DIATAS EKSPEKTASI' ? 'selected' :''}}>
                                                    DIATAS EKSPEKTASI</option>
                                                <option value="SESUAI EKSPEKTASI"
                                                    {{$u['rhk_tw'.$triwulan]=='SESUAI EKSPEKTASI' ? 'selected' :''}}>
                                                    SESUAI EKSPEKTASI</option>
                                                <option value="DIBAWAH EKSPEKTASI"
                                                    {{$u['rhk_tw'.$triwulan]=='DIBAWAH EKSPEKTASI' ? 'selected' :''}}>
                                                    DIBAWAH EKSPEKTASI</option>
                                            </select>
                                            <button type="submit" class='btn btn-sm btn-primary btn-block'>Update Rating
                                                Hasil Kerja</button>
                                        </form>
                                    </th>
                                </tr>
                        ...
                        <table class="table table-sm table-bordered">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    <a href="/pegawai/nilai-skp/ekspektasi/delete/{{$item->id}}"
                                        onclick="return confirm('Yakin Ingin Di hapus?');"><i
                                            class="fas fa-trash"></i></a> -{{$item->ekspektasi}} <br />
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="1" data-namapk="Berorientasi Pelayanan"><i
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="2" data-namapk="Akuntabel"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="3" data-namapk="Kompeten"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="4" data-namapk="Harmonis"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="5" data-namapk="Loyal"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="6" data-namapk="Adaptif"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td>Ekspektasi Khusus Pimpinan : <br />
                                    ...
                                    @endforeach
                                    <a href="#" class="ekspektasi" data-id="{{$u->id}}" data-tw="{{$triwulan}}"
                                        data-pkid="7" data-namapk="Kolaboratif"><i class="fas fa-plus-circle"></i></a>
                                </td>
                                <td>Pimpinan/Stakeholder (Nama) : </td>
                            </tr>
                        </table>
                        <table class="table table-sm table-bordered">
                            <thead>
                                ...
                                <tr>
                                    <th>
                                        <form method="post"
                                            action="/pegawai/nilai-rpk/triwulan/{{$triwulan}}/{{$u->id}}">
                                            @csrf

                                            <select name="rating" class="form-control text-sm" required>
                                                <option value="">-pilih-</option>
                                                <option value="DIATAS EKSPEKTASI"
                                                    {{$u['rpk_tw'.$triwulan]=='DIATAS EKSPEKTASI' ? 'selected' :''}}>
                                                    DIATAS EKSPEKTASI</option>
                                                <option value="SESUAI EKSPEKTASI"
                                                    {{$u['rpk_tw'.$triwulan]=='SESUAI EKSPEKTASI' ? 'selected' :''}}>
                                                    SESUAI EKSPEKTASI</option>
                                                <option value="DIBAWAH EKSPEKTASI"
                                                    {{$u['rpk_tw'.$triwulan]=='DIBAWAH EKSPEKTASI' ? 'selected' :''}}>
                                                    DIBAWAH EKSPEKTASI</option>
                                            </select>
                                            <button type="submit" class='btn btn-sm btn-primary btn-block'>Update Rating
                                                Perilaku Kerja</button>
                                        </form>
                                    </th>
                                </tr>
                            </thead>
...
<div class="modal fade" id="modal-edit" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/nilai-skp/triwulan/{{$triwulan}}/{{$u->id}}/jf"
...
<div class="modal fade" id="modal-tambah" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/nilai-skp/ekspektasi/{{$u->id}}/triwulan"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
...
<div class="modal fade" id="modal-komentar" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/nilai-skp/triwulan/{{$triwulan}}/{{$u->id}}/komentarja"
                enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                    <h4 class="modal-title text-sm">UMPAN BALIK</h4>
