    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Daftar TPP TU Bulan
            ...
            <div class="card-body p-2">
                <div class="alert alert-default alert-dismissible text-sm">
                    ...
                    laporan. Jika ada pegawai yang sudah mutasi/keluar namun masih di bayarkan TPP nya, klik <span
                        class="badge badge-primary">tambah pegawai</span>, pilih pegawai dan jabatan sebelum
                    pindah<br />


                    2. Klik Tombol <span class="badge badge-secondary">Tarik PSA</span> (Presensi, SKP, dan Aktivitas),
                    untuk menarik data presensi, data nilai SKP dan menit aktivitas<br />
                ...
                @if (checkKunciTU($bulan, $tahun, Auth::user()->skpd->id) == true)

                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/kuncitpptu"
                    class="btn btn-flat btn-xs btn-success"><i class="fa fa-lock"></i> Telah dikunci</a>
                @else
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tu/mp" class="btn btn-flat btn-xs btn-primary"
                    onclick="return confirm('Yakin Ingin Memasukkan Semua Pegawai Pada Bulan Ini?');">Masukkan
                    Semua Pegawai</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tu/psa" class="btn btn-flat btn-xs btn-secondary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Tarik PSA</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tu/perhitungan"
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/kuncitpptu" class="btn btn-flat btn-xs btn-danger"
                    ...
                    <thead>
                        <tr style="font-size:10px; font-family:Arial, Helvetica, sans-serif" class="text-center">
                            ...
                            <th style="background-color:#7ef8f8; border:1px solid silver" rowspan=4>PPH 21 (TER)
                                <br />
                                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tu/tarikter"
                        ...
                        @endif
                          ">
                            ...
                            <td>
                                ...
                                {!!wordwrap($item->sekolah->nama,40,"<br>")!!}
                            ...
                            <td class="text-right">{{number_format($item->bpjs1)}}
        ...
        <div class="modal-content">
            <form method="post" action="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tambahpegawai/reguler"
                ...
                <div class="modal-body">
                    ...
                    Pilih Jabatan
                    <select id="selectJabatan" class="form-control form-control-sm select2 selectJabatan"
                        name="jabatan">
