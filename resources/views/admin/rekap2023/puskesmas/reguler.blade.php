    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/puskes/reguler/mp" class="btn btn-flat btn-xs btn-primary"
                    onclick="return confirm('Yakin Ingin Memasukkan Semua Pegawai Pada Bulan Ini?');">Masukkan
                    Semua Pegawai</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/puskes/reguler/psa" class="btn btn-flat btn-xs btn-secondary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Tarik PSA</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/puskes/reguler/perhitungan" class="btn btn-flat btn-xs btn-warning"
...
<div class="modal fade" id="modal-tambahpegawai" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/tambahpegawai/puskes/reguler" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-success" style="padding:10px">
