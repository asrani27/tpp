                ...
                <div class="card">
                    <div class="card-body table-responsive p-0">
                        ...
                        @foreach ($data as $key => $item)
                                ...
                                <td>
                                    @if ($item->validasi == 0)
                                    <a href="/pegawai/plt/validasi/harian/acc_aktivitas/{{$item->id}}" class="btn btn-xs btn-success text-white" data-toggle="tooltip" title="Setujui Aktivitas" onclick="return confirm('Yakin ingin di Setujui?');"><i class="fas fa-check"></i> Setuju</a>
                                    <a href="/pegawai/plt/validasi/harian/tolak/{{$item->id}}" class="btn btn-xs btn-danger text-white" data-toggle="tooltip" title="Tolak Aktivitas"  onclick="return confirm('Yakin ingin di tolak?');"><i class="fas fa-times"></i> Tolak</a>
                                    @else
