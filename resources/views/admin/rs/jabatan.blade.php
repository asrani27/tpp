                ...
                <ul>
                    ...
                    <li>
                        <div class="callout callout-info text-sm" style="padding:5px;">
                            ...
                            <strong>{{$item->nama}}</strong> | {{$item->pegawai == null ? '':
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="callout callout-warning text-sm" style="padding:5px;">
                                    ...
                                    <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item2->id}}/edit"
                                        class="btn btn-tool" data-toggle="tooltip" title="Edit"><i
                                            class="fas fa-edit"></i></a>
                                    <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item2->id}}/delete"
                                        class="btn btn-tool" data-toggle="tooltip" title="Hapus"
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <div class="callout callout-danger text-sm" style="padding:5px;">
                                            ...
                                            <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item3->id}}/edit"
                                                class="btn btn-tool" data-toggle="tooltip" title="Edit"><i
                                                    class="fas fa-edit"></i></a>
                                            <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item3->id}}/delete"
                                                class="btn btn-tool" data-toggle="tooltip" title="Hapus"
                                                onclick="return confirm('Yakin ingin di hapus?');"><i
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div class="callout callout-danger text-sm" style="padding:5px;">
                                                    ...
                                                    <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item4->id}}/edit"
                                                        class="btn btn-tool" data-toggle="tooltip" title="Edit"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item4->id}}/delete"
                                                        class="btn btn-tool" data-toggle="tooltip" title="Hapus"
                                                        onclick="return confirm('Yakin ingin di hapus?');"><i
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        <div class="callout callout-danger text-sm"
                                                            ...
                                                            <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item5->id}}/edit"
                                                                class="btn btn-tool" data-toggle="tooltip"
                                                                title="Edit"><i class="fas fa-edit"></i></a>
                                                            <a href="/admin/rspuskesmas/{{$id}}/petajabatan/{{$item5->id}}/delete"
                                                                class="btn btn-tool" data-toggle="tooltip" title="Hapus"
                                                                onclick="return confirm('Yakin ingin di hapus?');"><i
