  ...
  <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-12">
        ...
        <a href="/superadmin/pegawai/createuser" class="btn btn-sm bg-purple"><i class="fas fa-key"></i> Create User &
          Pass ASN</a>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>{{$item->nip}}<br />
                    ...
                    <a href="/superadmin/pegawai/createuser/{{$item->id}}" class="btn btn-xs btn-secondary"><i
                  ...
                  <td>
                    @if ($item->user != null)
                    <a href="/superadmin/pegawai/resetpassword/{{$item->id}}" class="btn btn-sm btn-info"
                      data-toggle="tooltip" title='Reset Password'><i class="fas fa-key"></i></a>
                    @endif
                    <a href="/superadmin/pegawai/edit/{{$item->id}}" class="btn btn-sm btn-warning"
                    ...
                    <a href="/superadmin/pegawai/aktivitas/{{$item->id}}" class="btn btn-sm bg-purple"
                      data-toggle="tooltip" title='Edit data'>Aktivitas</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
