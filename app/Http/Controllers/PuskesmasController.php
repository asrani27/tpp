    ...
    public function pembayaran($bulan, $tahun)
    {
        ...
        foreach ($data as $item) {
            ...
            if ($jabatan == null) {
                ...
                $disiplin = round((($item->perhitungan_basic_tpp * $jabatan->persen_beban_kerja / 100) * ((40 / 100) * $absensi / 100)));
                $bk_disiplin = $disiplin < 0 ? 0 : $disiplin;
            ...
            $item->update([
                'pembayaran_absensi' => ($presensi == null ? null : $presensi->persen_kehadiran) < 0 ? 0 : $presensi->persen_kehadiran,
