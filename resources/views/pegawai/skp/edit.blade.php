...
<div class="row">
    <div class="col-md-12">
        <a href="/pegawai/skp/rencana-kegiatan" class="btn btn-sm btn-secondary"><i
                class="fas fa-arrow-alt-circle-left"></i> Kembali</a><br /><br />
        <div class="row">
            <div class="col-lg-12 col-12">
                <div class="card card-info">
                    ...
                    <form class="form-horizontal" method="POST"
                        action="/pegawai/skp/rencana-kegiatan/edit/{{$data->id}}/{{$periode_id}}">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label text-right">Nama
                                    Kegiatan</label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label text-right">Nilai Satuan
                                    AK</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="satuan_ak"
                                        value="{{$data->satuan_ak}}" onkeypress="return hanyaAngka(event)">
                                </div>
                            </div>

                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label text-right">Angka Kredit
                                    (Satuan AK * Kuantitas Volume)
                                </label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="kuantitas"
                                        value="{{$data->kuantitas}}" onkeypress="return hanyaAngka(event)">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="inputPassword3" class="col-sm-3 col-form-label text-right">Satuan
                                    Waktu</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="satuan_waktu"
