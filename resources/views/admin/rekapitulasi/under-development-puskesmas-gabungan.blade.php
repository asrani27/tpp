...
@section('title')
Rekap TPP RS, PUSKES, IFK, LABKES - Sedang Dalam Pengembangan
@endsection
            ...
            <div class="card-body text-center">
                <div class="py-5">
                    ...
                    <p class="text-muted mb-4">
                        Halaman <strong>Rekapitulasi TPP RS, PUSKES, IFK, LABKES</strong> saat ini sedang dalam tahap pengembangan.
                    </p>
                    <p class="text-muted mb-4">
