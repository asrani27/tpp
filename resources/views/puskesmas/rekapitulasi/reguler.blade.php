        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                <a href="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/mp"
                    ...
                    Semua Pegawai</a>
                <a href="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/psa"
                ...
                <a href="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/puskes/reguler/perhitunganrs"
                ...
                @else
                <a href="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/reguler/perhitungan"
                    class="btn btn-flat btn-xs btn-warning"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Perhitungan</a>
                @endif
                    ...
                    <thead>
                        <tr style="font-size:10px; font-family:Arial, Helvetica, sans-serif" class="text-center">
                            ...
                            <th style="background-color:#7ef8f8; border:1px solid silver" rowspan=4>PPH 21 (TER)
                                <br />
                                <a href="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/tarikter"
...
<div class="modal fade" id="modal-bpjs" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/puskesmas/rekapitulasi/bpjs/reguler" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modal-tambahpegawai" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/puskesmas/rekapitulasi/{{$bulan}}/{{$tahun}}/tambahpegawai/reguler"
