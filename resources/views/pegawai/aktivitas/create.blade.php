        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              @if (Auth::user()->username == '197508312010011005' || Auth::user()->username == '198609142011012004' || Auth::user()->username == '196906081997032006' || Auth::user()->username == '197002061992032005' || Auth::user()->username == '197404272008011015')
