                  ...
                  <table class="table table-hover text-nowrap">
                    ...
                    @foreach ($data as $key => $item)
                          <tr>
                            ...
                            <td>{{$item->nama}}</td>
                            <td>
                            <a href="/admin/rspuskesmas/{{$item->id}}/petajabatan" class="btn btn-sm bg-purple" data-toggle="tooltip" title='Peta Jabatan'><i class="fas fa-sitemap"></i> PETA JABATAN</a>
                            <a href="/admin/rspuskesmas/{{$item->id}}/edit" class="btn btn-sm btn-success" data-toggle="tooltip" title='Edit'><i class="fas fa-edit"></i></a>
                            <a href="/admin/rspuskesmas/{{$item->id}}/delete" class="btn btn-sm btn-danger" data-toggle="tooltip" title='Hapus data' onclick="return confirm('Yakin ingin di hapus?');"><i class="fas fa-trash"></i></a>
                            </td>
                          </tr>
                      @endforeach
                    </tbody>
