        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              ...
              {{-- @if (Auth::user()->username == '197508312010011005')
              ...
              {{-- <input type="date" class="form-control" name="tanggal" placeholder="" value="{{$tanggal}}"
                min="{{\Carbon\Carbon::today()->subdays(1)->format('Y-m-d')}}"
                max="{{\Carbon\Carbon::today()->addDays(31)->format('Y-m-d')}}"> --}}
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <select name="skp_id" class="form-control select2" required>
                ...
                @foreach ($skp as $item)
                <option value="{{$item->id}}" {{$item->id == old('skp_id') ? 'selected':''}}>{{$item->deskripsi}}
                </option>
                @endforeach
              </select>
            </div>
