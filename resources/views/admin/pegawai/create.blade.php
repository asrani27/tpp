                    ...
                    <div class="card-body table-responsive p-0">
                        <form class="form-horizontal" method="POST" action="/admin/pegawai/add">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nip" value="{{ $data['nip'] }}" required  minlength="18" maxlength="18" readonly>
                                    @if ($errors->has('nip'))
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="nama"  value="{{ $data['nm_lengkap'] }}" required readonly>
                                </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select2" name="jabatan_id">
                                            ...
                                            @foreach ($jabatan as $item)
                                                <option value="{{$item->id}}">{{$item->nama}} ({{$item->rs == null ? $item->skpd->nama:$item->rs->nama}}) - {{$item->atasan == null ? '-':'Atasan : '.$item->atasan->nama}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
