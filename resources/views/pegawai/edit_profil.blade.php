            ...
            <div class="card-body">
                <form method="POST" action="/pegawai/profil/gantipass">
                    ...
                    <input type="text" class="form-control" name="password2" required
                        placeholder="masukkan password Lagi"><br />
                    <button type="submit" class="btn btn-success btn-block"><i class="fas fa-key"></i> Ganti
                        Password</button>
                </form>
            ...
            <div class="card-body">
                <form class="form-horizontal" method="POST" action="/pegawai/profil/edit">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                value="{{$data->jabatan == null ? '' : $data->jabatan->nama}}" readonly>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="pangkat_id" class="form-control" required>
                                ...
                                <option value="{{$item->id}}" {{$data->pangkat->id == $item->id ?
                                    'selected':''}}>{{$item->nama}} ({{$item->golongan}})</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select name="eselon_id" class="form-control">
                                ...
                                <option value="{{$item->id}}" {{$data->eselon_id == $item->id ?
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control"
                                value="{{$data->skpd == null ? '' : $data->skpd->nama}}" readonly>
                        </div>
                    </div>
                    {{-- <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="no_rek"
                                value="{{$data->no_rek == null ? '' : $data->no_rek}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="npwp"
                                value="{{$data->npwp == null ? '' : $data->npwp}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" name="email"
                                value="{{$data->user == null ? '' : $data->user->email}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="telp"
                                value="{{$data->telp == null ? '' : $data->telp}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="inputPassword3" class="col-sm-3 col-form-label">Gol Darah</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="date" class="form-control" name="tanggal_lahir"
                                value="{{$data->tanggal_lahir == null ? '' : $data->tanggal_lahir}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <div class="offset-sm-3 col-sm-9">
                            <a href="/pegawai/profil" class="btn btn-secondary btn-block"><i
                                    class="fas fa-arrow-alt-circle-left"></i> <b>Kembali</b></a>
                        </div>
                    </div>
                </form>
            </div><!-- /.card-body -->
