    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                @else
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/cpns/mp" class="btn btn-xs btn-primary"
                    onclick="return confirm('Yakin Ingin Memasukkan Semua Pegawai Pada Bulan Ini?');">Masukkan
                    Pegawai CPNS</a>

                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/cpns/psa" class="btn btn-flat btn-xs btn-secondary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Tarik PSA</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/cpns/perhitungan" class="btn btn-xs btn-warning"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Perhitungan</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/cpns/kuncitpp" class="btn btn-flat btn-xs btn-danger"
                    ...
                    <thead>
                        <tr style="font-size:10px; font-family:Arial, Helvetica, sans-serif" class="text-center">
                            ...
                            <th style="background-color:#7ef8f8; border:1px solid silver" rowspan=4>PPH 21
                                <br />
                                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/cpns/tarikter"
...
<div class="modal fade" id="modal-bpjs" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" action="/admin/rekapitulasi/bpjs/cpns" enctype="multipart/form-data">
                @csrf
