                    ...
                    <tbody>
                        @foreach ($skp_utama as $key => $item)
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td rowspan="{{$item->indikator->count() + 1}}">{{$item->rhk}} 
                                    <a href="#" data-id="{{$item->id}}"
                                        data-rhk="{{$item->rhk}}" class="edit-skp-utama"><i class="fas fa-edit"></i></a>
                                    <a href="/pegawai/new-skp/utama/rhk/{{$item->id}}/delete" onclick="return confirm('Yakin ingin dihapus');"><i class="fas fa-trash"></i></a></td>
                                @php ($first = false) @endphp
                                @endif
                                <td>{{$item2->indikator}} 
                                    <a href="#" data-id="{{$item2->id}}"
                                        data-indikator="{{$item2->indikator}}" data-target="{{$item2->target}}" data-perspektif="{{$item2->perspektif}}" class="edit-indikator-utama"><i class="fas fa-edit"></i></a>
                                    <a href="/pegawai/new-skp/utama/rhk/{{$item->id}}/indikator/{{$item2->id}}/delete" onclick="return confirm('Yakin ingin dihapus');"><i class="fas fa-trash"></i></a>
                                </td>
                        ...
                        @foreach ($skp_tambahan as $key => $item)
                            ...
                            <tr style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; font-size:10px;">
                                ...
                                <td rowspan="{{$item->indikator->count() + 1}}">{{$item->rhk}} 
                                    <a href="#" data-id="{{$item->id}}"
                                        data-rhk="{{$item->rhk}}" class="edit-skp-tambahan"><i class="fas fa-edit"></i></a>
                                    <a href="/pegawai/new-skp/tambahan/rhk/{{$item->id}}/delete" onclick="return confirm('Yakin ingin dihapus');"><i class="fas fa-trash"></i></a></td>
                                @php ($first = false) @endphp
                                @endif
                                <td>{{$item2->indikator}} 
                                    <a href="#" data-id="{{$item2->id}}"
                                        data-indikator="{{$item2->indikator}}" data-target="{{$item2->target}}" data-perspektif="{{$item2->perspektif}}" class="edit-indikator-tambahan"><i class="fas fa-edit"></i></a>
                                    <a href="/pegawai/new-skp/tambahan/rhk/{{$item->id}}/indikator/{{$item2->id}}/delete" onclick="return confirm('Yakin ingin dihapus');"><i class="fas fa-trash"></i></a>
                                </td>
                                <td class="text-center">{{$item2->target}}</td>
                                <td class="text-center">{{$item2->perspektif}}</td>
                            </tr>
...
<div class="modal fade" id="modal-tambah" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/utama/rhk/{{$u->id}}" enctype="multipart/form-data">
                @csrf
...
<div class="modal fade" id="modal-edit" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/utama/rhk/{{$u->id}}/edit" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>RENCANA HASIL KERJA</label>
                        <input type="text" class="form-control" id="rhk" name="rhk">
...
<div class="modal fade" id="modal-tambah-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/utama/rhk/{{$u->id}}/indikator" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jpt_id" id="skp2023_jpt_id" required>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="perspektif" placeholder="perspektif" required>
                    </div>
                </div>
...
<div class="modal fade" id="modal-edit-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/utama/rhk/{{$u->id}}/indikator/edit" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                    <h4 class="modal-title text-sm">INDIKATOR SKP UTAMA</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jpt_indikator_id" id="skp2023_jpt_indikator_id">
                        <label>INDIKATOR</label>
...
<div class="modal fade" id="t-modal-tambah" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/tambahan/rhk/{{$u->id}}" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label>RENCANA HASIL KERJA</label>
                        <input type="text" class="form-control" name="rhk_tambahan" placeholder="rencana hasil kerja" required>
                    </div>
                </div>
...
<div class="modal fade" id="t-modal-edit" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/tambahan/rhk/{{$u->id}}/edit" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
...
<div class="modal fade" id="t-modal-tambah-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/tambahan/rhk/{{$u->id}}/indikator" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jpt_id_tambahan" id="skp2023_jpt_id_tambahan" required>
                        <label>INDIKATOR</label>
                        <input type="text" class="form-control" name="indikator" placeholder="indikator" required>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="t-modal-edit-indikator" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="post" action="/pegawai/new-skp/tambahan/rhk/{{$u->id}}/indikator/edit" enctype="multipart/form-data">
                @csrf
                <div class="modal-header bg-gradient-primary" style="padding:10px">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="skp2023_jpt_indikator_id_tambahan" id="skp2023_jpt_indikator_id_tambahan">
                        <label>INDIKATOR</label>
                    ...
                    <div class="form-group">
                        <label>PERSPEKTIF</label>
                        <input type="text" class="form-control" name="perspektif" id="perspektif_tambahan" required>
                    </div>
                </div>
...
$(document).on('click', '.skp-tambahan', function() {
 ...
 $(document).on('click', '.t-indikator-skp-tambahan', function() {
    $('#skp2023_jpt_id_tambahan').val($(this).data('id'));
    $("#t-modal-tambah-indikator").modal();
 });
 
 $(document).on('click', '.edit-indikator-tambahan', function() {
    $('#skp2023_jpt_indikator_id_tambahan').val($(this).data('id'));
