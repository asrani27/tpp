    ...
    <div class="col-lg-12 col-12">
      <div class="info-box">
        ...
        <div class="info-box-content">
          ...
          <span class="info-box-number">H. IBNU SINA</span>
        </div>
        <!-- /.info-box-content -->
      </div>
      <!-- /.info-box -->
                    ...
                    @foreach ($data as $key => $item)
                          <tr>
                            ...
                            <td>
                              ...
                              <a href="/walikota/nilai-skp/triwulan/1/{{$item->id}}" class="btn btn-xs btn-success">TRIWULAN 1 : {{$item->nilai_tw1}}</a>
                              <a href="/walikota/nilai-skp/triwulan/2/{{$item->id}}" class="btn btn-xs btn-success">TRIWULAN 2 : {{$item->nilai_tw2}}</a>
                              <a href="/walikota/nilai-skp/triwulan/3/{{$item->id}}" class="btn btn-xs btn-success">TRIWULAN 3 : {{$item->nilai_tw3}}</a>
                              <a href="/walikota/nilai-skp/triwulan/4/{{$item->id}}" class="btn btn-xs btn-success">TRIWULAN 4 : {{$item->nilai_tw4}}</a>
                            </td>
                          </tr>
                      @endforeach
                    </tbody>
