      ...
      <div class="card-body">
        <form class="form-horizontal">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{$data->jabatan == null ? '' : $data->jabatan->nama}}"
                readonly>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control"
                value="{{$data->pangkat == null ? '' : $data->pangkat->nama.'('.$data->pangkat->golongan.')'}}"
                readonly>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{$data->eselon == null ? '' : $data->eselon->nama}}"
                readonly>
            </div>
          </div>
          <div class="form-group row">
          ...
          {{-- <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control"
                value="{{($data->jabatan == null ? '' : $data->jabatan->atasan) == null ? 'Sekda' : $data->jabatan->atasan->pegawai->nama}}"
                readonly>
            </div>
          </div> --}}
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="no_rek"
                value="{{$data->no_rek == null ? '' : $data->no_rek}}" readonly>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="email"
                value="{{$data->user == null ? '' : $data->user->email}}" readonly>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" name="alamat"
                value="{{$data->alamat == null ? '' : $data->alamat}}" readonly>
            </div>
          </div>
          <div class="form-group row">
          ...
          <div class="form-group row">
            <label for="inputName" class="col-sm-3 col-form-label">Telp</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{$data->telp == null ? '' : $data->telp}}" readonly>
            </div>
          </div>
          <div class="form-group row">
            <label for="inputName" class="col-sm-3 col-form-label">Golongan Darah</label>
            <div class="col-sm-9">
              <input type="text" class="form-control" value="{{$data->gol_darah == null ? '' : $data->gol_darah}}"
                readonly>
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control"
                value="{{$data->jenjang_pendidikan == null ? '' : $data->jenjang_pendidikan}}" readonly>
            </div>
            <div class="col-sm-7">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-2">
              <input type="text" class="form-control"
                value="{{$data->tanggal_lahir == null ? '' : $data->tanggal_lahir}}" readonly>
            </div>
            <div class="col-sm-7">
              <input type="text" class="form-control"
                value="{{$data->tanggal_lahir == null ? '' : \Carbon\Carbon::parse($data->tanggal_lahir)->diff(\Carbon\Carbon::now())->format('%y Tahun, %m Bulan and %d Hari')}}"
                readonly>
            </div>
          </div>
          <div class="form-group row">
