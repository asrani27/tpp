    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body p-2">
                ...
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/rs/reguler/mp" class="btn btn-flat btn-xs btn-primary"
                    onclick="return confirm('Yakin Ingin Memasukkan Semua Pegawai Pada Bulan Ini?');">Masukkan
                    Semua Pegawai</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/rs/reguler/psa" class="btn btn-flat btn-xs btn-secondary"
                    onclick="return confirm('Proses ini memakan beberapa waktu, harap di tunggu?');">Tarik PSA</a>
                <a href="/admin/rekapitulasi/{{$bulan}}/{{$tahun}}/rs/reguler/perhitungan" class="btn btn-flat btn-xs btn-warning"
